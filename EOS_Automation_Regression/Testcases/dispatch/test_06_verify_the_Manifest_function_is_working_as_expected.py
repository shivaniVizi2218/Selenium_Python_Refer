...
#Verify that the "Manifest" function is working as expected
#https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/4914

class Test_365_testcase:
    EOSURL = ReadEOSurlConfig.getEOSuRL()

    def test_365_testcase(self, setup):
        self.driver = setup
