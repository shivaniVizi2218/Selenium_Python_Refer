...
#TC-119
#https://lasership.qtestnet.com/p/114924/portal/project#tab=testdesign&object=1&id=49516595

class Test_119_testcase:
    EOSURL = ReadEOSurlConfig.getEOSuRL()

    def test_119_TC118_tescase(self, setup):
        self.driver = setup
        ...
        time.sleep(60)  #wait 1 minute per the step in testcase
