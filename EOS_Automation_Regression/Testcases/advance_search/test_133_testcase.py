...
#TC-133
#https://lasership.qtestnet.com/p/114924/portal/project#tab=testdesign&object=1&id=49875316

class Test_133_testcase:
    EOSURL = ReadEOSurlConfig.getEOSuRL()

    def test_133_tescase(self, setup):
        self.driver = setup
        ...
        self.advance_search.change_package_status("Exception", "Mechanical Breakdown Will Impact Delivery")
        self.advance_search.search_packg_in_advance_search(barcode)
        self.advance_search.click_barcode1()
        self.driver.close()
