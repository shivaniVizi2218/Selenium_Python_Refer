...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2479
...
class Test_TC_2479:
    ...
    def test_TC_2479(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["scan_by_inactive_driver_report_name"])
        time.sleep(15)
        self.all_eos_reports_dashboard.verify_scan_by_inactive_drivers(previous_day_current_date(),self.bolt_data["load_without_departure_facility"],self.bolt_data["scan_by_inactive_drivers_report_headers"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["scan_by_inactive_driver_report_name"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
