...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2482
...
class Test_TC_2482:
    ...
    def test_TC_2482(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["reference_search_report_name"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_reference_search(self.bolt_data["reference_number"],self.bolt_data["reference_headers"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["reference_search_report_name"],self.bolt_data["file_formats_for_report_download_1"],self.bolt_data["file_extension_for_report_download_1"])
