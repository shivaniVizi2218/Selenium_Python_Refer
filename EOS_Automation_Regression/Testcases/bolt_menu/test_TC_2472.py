...
class Test_TC_2472:
    ...
    def test_TC_2472(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["report_evil2_drivers"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_eli2_drivers(self.bolt_data["evils_driver_report_header_column"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["report_evil2_drivers"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
