...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2471
...
class Test_TC_2471:
    ...
    def test_TC_2471(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["report_flight_light"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_facility_status_light_page(self.bolt_data["flight_light_column_header"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["report_flight_light"],self.bolt_data["file_formats_for_report_download_1"],self.bolt_data["file_extension_for_report_download_1"])
