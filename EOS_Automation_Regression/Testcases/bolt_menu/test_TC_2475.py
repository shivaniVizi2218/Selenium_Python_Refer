...
class Test_TC_2475:
    ...
    def test_TC_2475(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["report_open_stops_report_all"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_open_stops_reports_All(self.bolt_data["load_without_departure_start_date"],self.bolt_data["load_without_departure_end_date"],self.bolt_data["open_stop_report_all_result_table_column_headers"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["report_open_stops_report_all"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
