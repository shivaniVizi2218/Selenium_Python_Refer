...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2478
...
class Test_TC_2478:
    ...
    def test_TC_2478(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["miss_short_tracker_report_name"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_miss_short_tracker_report(self.bolt_data["load_without_departure_start_date"],self.bolt_data["miss_short_tracker_status"],self.bolt_data["miss_short_tracker_report_table_column_header"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["miss_short_tracker_report_name"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
