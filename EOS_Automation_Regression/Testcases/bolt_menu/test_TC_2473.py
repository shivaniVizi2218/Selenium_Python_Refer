...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2473
...
class Test_TC_2473:
    ...
    def test_TC_2473(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["report_load_without_departure_event"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_load_without_departure_event_page(self.bolt_data["load_without_departure_start_date"],self.bolt_data["load_without_departure_end_date"],self.bolt_data["load_without_departure_facility"],self.bolt_data["load_without_departure_report_headers"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["report_load_without_departure_event"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
