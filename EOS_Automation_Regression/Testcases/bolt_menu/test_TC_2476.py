...
class Test_TC_2476:
    ...
    def test_TC_2476(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["unable_to_deliver_exception_report_name"])
        time.sleep(15)
        self.all_eos_reports_dashboard.verify_unable_to_deliver_exceptions_LOD_404_423(self.bolt_data["unable_to_deliver_exception_report_date"],self.bolt_data["unable_to_deliver_exception_event_name"],self.bolt_data["unable_to_deliver_exception_no_action"],self.bolt_data["unable_to_deliver_exceptions_report_column_header"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["unable_to_deliver_exception_report_name"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
