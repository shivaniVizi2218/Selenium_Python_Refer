...
# https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2470
...
class Test_TC_2470:
    ...
    def test_TC_2470(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["report_arrival_scan"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_arrival_scan_page(self.bolt_data["arrival_scan_table_column_headers"],self.bolt_data['arrival_scan_date'])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["report_arrival_scan"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
