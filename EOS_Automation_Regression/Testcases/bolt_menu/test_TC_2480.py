...
class Test_TC_2480:
    ...
    def test_TC_2480(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["delivered_by_driver_report_name"])
        time.sleep(15)
        self.all_eos_reports_dashboard.verify_delivered_by_driver_report(previous_day_current_date(),datetime.now().date().strftime('%m-%d-%Y'),self.bolt_data["load_without_departure_facility"],self.bolt_data["driver_number"],self.bolt_data["delivered_by_driver_report_column_headers"])
        self.all_eos_reports_dashboard.verify_export_dropdown_option(self.bolt_data["export_to_file_option_files"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["delivered_by_driver_report_name"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
