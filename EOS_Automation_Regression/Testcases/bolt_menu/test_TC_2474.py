...
class Test_TC_2474:
    ...
    def test_TC_2474(self, setup):
        ...
        self.all_eos_reports_dashboard.run_paginated_reports(self.bolt_data["hub_arrival_wrong_facility_report_name"])
        time.sleep(10)
        self.all_eos_reports_dashboard.verify_hub_arrival_wrong_report_page(self.bolt_data["hub_arrival_original_EDD_date"],self.bolt_data["hub_arrival_wrong_facility_result_column_headers"])
        self.all_eos_reports_dashboard.verify_downloaded_reports_in_all_formate(self.bolt_data["hub_arrival_wrong_facility_report_name"],self.bolt_data["file_formats_for_report_download"],self.bolt_data["file_extension_for_report_download"])
