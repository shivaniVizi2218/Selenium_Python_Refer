...
#https://dev.azure.com/OnTracDevelopment/Holistic%20Software%20Destroyers/_workitems/edit/2461
...
class Test_TC_2461:
    ...
    def test_TC_2461(self, setup):
        ...
        self.dailyClouseout.select_start_date()
        self.dailyClouseout.select_end_date()
        self.dailyClouseout.verify_ofd_after_run(stop_name=stop_name_random.lower())
        notes_text = self.daily_closeout_dashboard_data["Notes_text"]+stop_name_random.lower()
        self.dailyClouseout.select_one_exception_option(notes_text)
        print(notes_text,"*****************************")
        route = self.dailyClouseout.verify_package_under_exc_column_of_delivery_tab(barcode)
        self.dailyClouseout.verify_package_under_facility_db_exceptions_tab(route)
        self.dailyClouseout.verify_test_data(stop_name=stop_name_random)
