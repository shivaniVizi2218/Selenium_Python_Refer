...
class Test_1679_testcase:
    EOSURL = ReadEOSurlConfig.getEOSuRL()

    def test_1679_testcase(self, setup):
        self.driver = setup
        ...
        time.sleep(2)
        self.advance_search.change_package_status(status="Attempt",exception="Already Picked Up",save_status="yes")
        self.facility_dash.find_package_in_pickup_exception_column(barcode,"Attempt")
        self.driver.close()