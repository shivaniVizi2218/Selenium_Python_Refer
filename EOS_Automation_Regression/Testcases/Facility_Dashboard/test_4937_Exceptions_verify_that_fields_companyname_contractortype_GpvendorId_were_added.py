...
class Test_4937_Exceptions_tab_verify_company_contractor_GPVendor_fields_added:
    # self.driver = setup
    ...
    def test_2393_deliveries_tab_verify_company_contractor_GPVendor_fields_added(self, setup):
        ...
        self.facility_dashboard.exceptions1_verify_that_the_fields_comp_contra_GPvendor_fields_added()
        self.driver.close()